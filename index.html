...
header {
  background: linear-gradient(135deg,#0756b8,#0a7cff);
  color: white;
  padding: 28px;
}
...
id="pesquisa"
oninput="renderizar()"
placeholder="Atividade, técnico ou local">
...
const API_URL =
"https://script.google.com/macros/s/AKfycbzVRxiZGWHc904IEroZfZHJ9oPhz34z_PWmkPsOWmsz5RRtABNf6NYSLHbrgNxzdTrp/exec";
...
function atualizarInterfaceLogin() {
  ...
  document
    ...
    .style.display =
    admin ? "none" : "inline-block";

  document
    .getElementById("btnSair")
    .style.display =
    admin ? "inline-block" : "none";

  document
    .getElementById("usuarioStatus")
    .textContent =
    admin
...
async function salvarAtividade() {
  ...
  if (!token) {
    ...
    alert(
      "Faça login para adicionar atividades."
    );
  ...
  if (
    ...
    alert(
      "Informe pelo menos a data e a atividade."
    );
